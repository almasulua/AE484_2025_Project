...
% Paths to functions
addpath C:\Users\User\Desktop\METU\AE484\Proje\main\Localization_INS_VOR_DME\ins
addpath C:\Users\User\Desktop\METU\AE484\Proje\main\Localization_INS_VOR_DME\ins-gnss
addpath C:\Users\User\Desktop\METU\AE484\Proje\main\Localization_INS_VOR_DME\conversions
addpath C:\Users\User\Desktop\METU\AE484\Proje\main\Localization_INS_VOR_DME\performance-analysis
addpath C:\Users\User\Desktop\METU\AE484\Proje\main\Localization_INS_VOR_DME\plot
addpath C:\Users\User\Desktop\METU\AE484\Proje\main\Localization_INS_VOR_DME\allan-variance
addpath C:\Users\User\Desktop\METU\AE484\Proje\main\Localization_INS_VOR_DME\Radio-Navigation
...
%% TIME INTERVAL
%%
tmin = 7009129;     % GNSS first time
tmax = 2720692353 ;   % GNSS last time 

%% REFERENCE
%% Referans şimdilik GPS olarak alındı
% load ref_zedf9p.mat
...
% load ref_zedf9p.mat
% ref_data = struct2table(ref_data);
reference_gnss = readtable("OnboardGPS.csv");

% ref data structure
ref.lat = reference_gnss.lat * D2R;
ref.lon = reference_gnss.lon * D2R;
ref.t = double(reference_gnss.Timpstemp/1e06);
ref.h = reference_gnss.alt;
% Serveral fields are missing: roll, pitch, yaw,vel etc.  
...
referans_acc = readtable("RawAccel.csv");
referans_gyro = readtable("RawGyro.csv");




% IMU data structure
imu.t = double(referans_gyro.Timpstemp/1e06);
imu.fb = [referans_acc.x referans_acc.y referans_acc.z ] ;
imu.wb = [referans_gyro.x referans_gyro.y referans_gyro.z] ;
...
% IMU data structure
gnss.t = double(reference_gnss.Timpstemp/1e06);
gnss.lat = reference_gnss.lat * D2R;
gnss.lon = reference_gnss.lon * D2R;
gnss.h = reference_gnss.alt;
gnss.vel = [ reference_gnss.vel_n_m_s reference_gnss.vel_e_m_s reference_gnss.vel_d_m_s] ;
